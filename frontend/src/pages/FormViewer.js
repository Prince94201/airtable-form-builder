...
function FormViewer() {
  ...
  const fetchForm = async () => {
    try {
      const response = await axios.get(`https://airtable-form-builder-xqkq.onrender.com/api/forms/${formId}`);
  ...
  const submitForm = async () => {
    ...
    try {
      await axios.post(`https://airtable-form-builder-xqkq.onrender.com/api/forms/${formId}/submit`, { answers });
      setSubmitted(true);
    } catch (error) {
